...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HISTORICDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_HISTORICDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HISTORICDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HISTORICDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HISTORICDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HISTORICDATA actions', async () => {
      const expectedActions = [
        {
