...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUIRENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_REQUIRENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REQUIRENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REQUIRENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REQUIRENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REQUIRENTS actions', async () => {
      const expectedActions = [
        {
