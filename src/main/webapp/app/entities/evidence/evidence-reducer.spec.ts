...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './evidence.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVIDENCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_EVIDENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EVIDENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EVIDENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EVIDENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EVIDENCE actions', async () => {
      const expectedActions = [
        {
